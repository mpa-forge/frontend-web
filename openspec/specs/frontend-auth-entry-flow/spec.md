# frontend-auth-entry-flow Specification

## Purpose

Define the real Clerk-backed sign-in and sign-up entry flow for the frontend
SPA, including safe post-auth return behavior and explicit route-local fallback
states.
